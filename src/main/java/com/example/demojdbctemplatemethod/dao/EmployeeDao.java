package com.example.demojdbctemplatemethod.dao;

import com.example.demojdbctemplatemethod.ds.Employee;
...
public class EmployeeDao {
    ...
    public Employee findEmployeeWithHighSalary(){
        return jdbcTemplate.queryForObject("select employee_id,first_name,last_name,email,phone_number,hire_date,salary from employee order by salary desc limit 1",
                this::mapEmployee);
    }
    ...
    public void insertNewDummyRecord(){
        jdbcTemplate.execute("insert into employee values (99,'Dummy','Dummy','Dummy@gamil.com','111-11-11','2019-06-05',1)");
    }

    public int updateRecord(Integer id,String firstName){
